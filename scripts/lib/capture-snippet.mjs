...
//
// Two CSP accommodations vs. the stock snippet, required by THIS site's live
// response headers (verified in-browser 2026-07-23):
//  1. `require-trusted-types-for 'script'` is enforced with no `trusted-types`
//     allowlist directive, so the loader's runtime `script.src = <string>` is
...
// place a default policy gets registered for every page this snippet ships
// on, and both the calculator's render() (o.innerHTML=...) and this same
// file's own capture-block success handler (msg.innerHTML=..., below) need
// createHTML too - whichever script runs first wins the registration, and
// every sink on the page shares it after that. The 2026-07-23 fix that
// added this policy covered only the loader path: PostHog began firing, but
// render() and the success message still threw "This document requires
// 'TrustedHTML' assignment" - which is why tools_subscribe_submitted had a
// 0% fire rate despite real submits reaching the backend (the throw happens
// before the capture() call in the .then() handler below).
export const POSTHOG_SNIPPET = `<script>if(window.trustedTypes&&trustedTypes.createPolicy&&!trustedTypes.defaultPolicy){try{trustedTypes.createPolicy('default',{createHTML:function(s){return s},createScriptURL:function(u){return u},createScript:function(s){return s}})}catch(e){}}!function(t,e){var o,n,p,r;e.__SV||(window.posthog=e,e._i=[],e.init=function(i,s,a){function g(t,e){var o=e.split(".");2==o.length&&(t=t[o[0]],e=o[1]),t[e]=function(){t.push([e].concat(Array.prototype.slice.call(arguments,0)))}}(p=t.createElement("script")).type="text/javascript",p.crossOrigin="anonymous",p.async=!0,p.src=s.api_host+"/static/array.js",(r=t.getElementsByTagName("script")[0]).parentNode.insertBefore(p,r);var u=e;for(void 0!==a?u=e[a]=[]:a="posthog",u.people=u.people||[],u.toString=function(t){var e="posthog";return"posthog"!==a&&(e+="."+a),t||(e+=" (stub)"),e},u.people.toString=function(){return u.toString(1)+".people (stub)"},o="init capture register register_once register_for_session unregister unregister_for_session getFeatureFlag getFeatureFlagPayload isFeatureEnabled reloadFeatureFlags updateEarlyAccessFeatureEnrollment getEarlyAccessFeatures on onFeatureFlags onSessionId getSurveys getActiveMatchingSurveys renderSurvey canRenderSurvey getNextSurveyStep identify setPersonProperties group resetGroups setPersonPropertiesForFlags resetPersonPropertiesForFlags setGroupPropertiesForFlags resetGroupPropertiesForFlags reset get_distinct_id getGroups get_session_id get_session_replay_url alias set_config startSessionRecording stopSessionRecording sessionRecordingStarted captureException loadToolbar get_property getSessionProperty createPersonProfile opt_in_capturing opt_out_capturing has_opted_in_capturing has_opted_out_capturing clear_opt_in_out_capturing debug getPageViewId captureTraceFeedback captureTraceMetric".split(" "),n=0;n<o.length;n++)g(u,o[n]);e._i.push([i,s,a])},e.__SV=1)}(document,window.posthog||[]);posthog.init('phc_lyZCgvTpicjLzAO3rY2GhxuX5WUc5jQjP8ZVwwJqauX',{api_host:'https://eu.i.posthog.com',person_profiles:'identified_only'})</script>`;
...
<section class="cap" style="margin:1.75rem 0;background:#ecfdf5;border:1px solid #6ee7b7;border-radius:.6rem;padding:1.25rem">
  ...
  <form class="cap-form" method="post" style="display:flex;flex-wrap:wrap;gap:.5rem">
    <input type="email" name="email" required autocomplete="email" aria-label="Email address" placeholder="you@company.com" style="flex:1 1 220px;padding:.6rem;border:1px solid #cbd5e1;border-radius:.4rem;font-size:1rem">
