...
set -e
for dir in vs for glossary faq learn pricing-questions integrations templates weekly-reports best how-to use-cases guides scenarios redflags cost-of checklists free lien-law-deadlines; do
  if [ -d "$dir" ]; then
    mkdir -p "dist/$dir"
