...
export default function ComparisonsHub() {
  return (
    <>
      <Helmet>
        <title>VoiceLogPro vs Competitors | Construction Daily Report Comparisons</title>
      ...
      <main className="min-h-screen bg-background">
        <section className="section-container max-w-4xl mx-auto py-16 px-4">
          <h1 className="text-4xl md:text-5xl font-display font-bold text-foreground mb-6">
            VoiceLogPro vs Competitors
          </h1>
          <p className="text-xl text-muted-foreground mb-8">
            Honest, detailed comparisons showing why subcontractors choose VoiceLogPro for payment protection — not just project management.
          </p>
