...
export default function ContactPage() {
  return (
    <>
      <Helmet>
        <title>Contact Voice Log Pro | Daily Construction Reports Support</title>
        <meta
          name="description"
        ...
        <meta
          ...
          content="Get in touch with Voice Log Pro. Questions about daily construction reporting? We're here for the crew."
        />
        <meta
          property="og:image"
        ...
        <meta name="twitter:title" content="Contact Voice Log Pro" />
        <meta name="twitter:description" content="Contact the Voice Log Pro crew." />
      </Helmet>
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="max-w-4xl mx-auto px-4 py-16 md:py-24 text-center">
          ...
          <h1 className="font-display text-4xl md:text-6xl uppercase text-foreground mb-6 leading-tight">
            Contact <span className="text-primary">Voice Log Pro</span>
          </h1>
        ...
        <section className="bg-card border-y border-border py-16">
          <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-background border border-border rounded-lg p-5">
                <h3 className="font-bold text-foreground mb-1">Can I compare Voice Log Pro to other tools?</h3>
                <p className="text-sm text-muted-foreground">
