...
import newYorkLienLaw from "@/content/blog/new-york-lien-law-article-2";

export default function NewYorkLienLawPage() {
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>{newYorkLienLaw.title} | VoiceLogPro</title>
        <meta name="description" content={newYorkLienLaw.metaDescription} />
        <meta name="keywords" content={newYorkLienLaw.keywords.join(", ")} />
        <link rel="canonical" href={`https://voicelogpro.com/blog/${newYorkLienLaw.slug}`} />
        <meta property="og:title" content={newYorkLienLaw.title} />
        <meta property="og:description" content={newYorkLienLaw.metaDescription} />
        <meta property="og:type" content="article" />
      </Helmet>
      
      <JsonLd schema={newYorkLienLaw.faqSchema} />
      ...
      <article className="container max-w-4xl px-4 py-12">
        <header className="mb-12">
          <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground mb-4">
            <span className="flex items-center gap-1">
              ...
              {newYorkLienLaw.jurisdiction}
            </span>
            <span className="flex items-center gap-1">
              <Calendar className="h-4 w-4" />
              {new Date(newYorkLienLaw.publishedAt).toLocaleDateString('en-US', { 
                year: 'numeric', 
                month: 'long', 
                day: 'numeric' 
              })}
        ...
        ">
          <MarkdownContent content={newYorkLienLaw.content} />
        </div>
        ...
        <footer className="mt-12 pt-8 border-t border-border">
          <p className="text-sm text-muted-foreground">
            ...
            New York Lien Law Article 2 is subject to change. Consult a licensed New York attorney for specific legal guidance 
            regarding mechanics lien rights and trust fund provisions.
          </p>
        </footer>
      </article>
