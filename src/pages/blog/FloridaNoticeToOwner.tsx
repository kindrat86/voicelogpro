...
import floridaNoticeToOwner from "@/content/blog/florida-nty-45-day-notice";

export default function FloridaNoticeToOwnerPage() {
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>{floridaNoticeToOwner.title} | VoiceLogPro</title>
        <meta name="description" content={floridaNoticeToOwner.metaDescription} />
        <meta name="keywords" content={floridaNoticeToOwner.keywords.join(", ")} />
        <link rel="canonical" href={`https://voicelogpro.com/blog/${floridaNoticeToOwner.slug}`} />
        <meta property="og:title" content={floridaNoticeToOwner.title} />
        <meta property="og:description" content={floridaNoticeToOwner.metaDescription} />
        <meta property="og:type" content="article" />
      </Helmet>
      
      <JsonLd schema={floridaNoticeToOwner.faqSchema} />
      ...
      <article className="container max-w-4xl px-4 py-12">
        <header className="mb-12">
          <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground mb-4">
            <span className="flex items-center gap-1">
              ...
              {floridaNoticeToOwner.jurisdiction}
            </span>
            <span className="flex items-center gap-1">
              <Calendar className="h-4 w-4" />
              {new Date(floridaNoticeToOwner.publishedAt).toLocaleDateString('en-US', { 
                year: 'numeric', 
                month: 'long', 
                day: 'numeric' 
              })}
        ...
        ">
          <MarkdownContent content={floridaNoticeToOwner.content} />
        </div>
        ...
        <footer className="mt-12 pt-8 border-t border-border">
          <p className="text-sm text-muted-foreground">
            ...
            Florida Statutes Chapter 713 is subject to change. Consult a licensed Florida attorney for specific legal guidance 
