...
export function AudioTestimonialButton({
  ...
  return <div className="flex items-center gap-2 mt-2">
      <button onClick={togglePlay} className="w-10 h-10 rounded-full bg-primary/10 hover:bg-primary/20 flex items-center justify-center transition-colors" aria-label={isPlaying ? `Pause ${name}'s testimonial` : `Play ${name}'s testimonial`}>
