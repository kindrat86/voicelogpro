  ...
  return <section className="section-container bg-secondary/30">
      ...
      <div className="card-sunlight p-6 md:p-8 mb-12">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <select id="region-select" value={selectedRegion} onChange={e => setSelectedRegion(e.target.value as RegionKey)} className="w-full max-w-xs h-14 md:h-12 px-4 text-base font-medium bg-background border-2 border-primary/50 rounded-lg text-foreground focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-colors cursor-pointer">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex flex-col items-center">
            ...
            {/* Learn More Link */}
            <Link to={currentCompliance.href} className="inline-flex items-center gap-1 mt-4 text-primary font-medium hover:underline">
